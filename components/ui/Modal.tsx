  ...
  return (
    ...
    >
      <section class="h-full bg-default flex flex-col">
        <header class="flex px-4 justify-between items-center py-4 border-b-1 border-default bg-badge text-default-inverse">
          <h1>
            <Text class="uppercase font-logo text-2xl" tone="default-inverse">
              {title}
            </Text>
          </h1>
